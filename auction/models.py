...
class Auction_item(models.Model):
    ...
    owner = models.ForeignKey(User, related_name="item", on_delete=models.CASCADE)
...
class Bid(models.Model):
    bidder = models.ForeignKey(User, related_name="bid", on_delete=models.CASCADE)
...
class Watchlist(models.Model):
    owner = models.ForeignKey(User, related_name="watchlist", on_delete=models.CASCADE)
    item = models.ManyToManyField(Auction_item, related_name="watchlist", blank=True)
